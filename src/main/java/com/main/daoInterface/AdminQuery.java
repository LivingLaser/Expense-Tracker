...
public interface AdminQuery {
	...
	String SELECT_ALL_RECORD = "select uid, type, name, amount, icon, DATE_FORMAT(date, '%d-%m-%Y') as date, date as old_date, time from transaction order by STR_TO_DATE(date, '%d-%m-%Y') desc";
